    ...
    <>
      <div className="course-text">
        ...
        <div className="text mx-4">
          ...
          Eyecandle
          專業的調香講師一步一步引導與帶領，讓大家能夠輕鬆做出專屬自己的香氛產品。
          <br />
          我們在意的不只是最終的成品，更希望能帶給你們難忘的香氛體驗。 /
          關於我們的香氛精油 / <br />
          由 Eyecandle 精選的香氛精油 ─ Robertet 為法國 200
          年歷史的香氛品牌，使用花、葉、木材、樹皮、樹根、種子、果皮等天然植物為原料，並以水力蒸餾、提純、分子蒸餾、臨界
          CO2 萃取、共蒸餾等方式提煉出最完美芬芳的香氛精油。
          <br />
